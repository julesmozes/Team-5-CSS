...
def plot_effort(fitness_history):
    ...
    plt.figure()
    plt.plot(gens, mean_fitness, linewidth=2, label="Mean fitness, lower is better")
    plt.fill_between(
        gens,
...
def main():
    # colony_population_evolution = EvolveColonies(number_colonies=40,
    #                                             ants_per_colony=100,
    #                                             generations=40, 
    #                                             iterations=800, 
    #                                             mutation_rate=0.2, 
